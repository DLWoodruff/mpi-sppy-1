...
class SPBase:
    ...
    def allreduce_or(self, val):
        # CONTROL RUN (LOR_bug_control): original un-instrumented allreduce_or.
        # The PR #717 LOR_bug instrumentation (4 extra Allreduces + 1 Allgather
        # and ~9 numpy allocations per call) is removed here so we can tell
        # whether the heap corruption / negative-count failures are real or an
        # artifact of the diagnostic's collective volume. Canary guards and the
        # teardown fixes are intentionally kept.
