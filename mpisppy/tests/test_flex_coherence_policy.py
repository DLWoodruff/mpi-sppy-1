...
identically there and cannot distinguish the policies. (The APH integration
test, test_flexible_rank_aph, does drive an asynchronous sender, but timing
makes it impossible to deterministically force a *particular* mixed-write_id
snapshot at a read.) These tests pin the behavior directly, without MPI:
